        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?php echo e(asset('images/taller.jpg')); ?>" class="d-block w-100" alt="Servicio en casa">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/equipo.jpg')); ?>" class="d-block w-100" alt="Equipo trabajando">
                </div>
                <div class="carousel-item">
                    <img src="<?php echo e(asset('images/taller1.jpg')); ?>" class="d-block w-100" alt="Reparaciones">
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SERGIO\Documents\GitHub\larav0207\larav0207\resources\views/nosotros.blade.php ENDPATH**/ ?>