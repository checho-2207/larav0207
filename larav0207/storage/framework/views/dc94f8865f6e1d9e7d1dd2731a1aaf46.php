...
<head>
    ...
    <style>
        ...
        .map-section {
            position: relative;
            height: 400px;
            background-image: url('<?php echo e(asset('images/mapa.jpg')); ?>'); /* Ruta de la imagen de fondo */
    ...
    <div class="cards-container">
        ...
        <div class="card">
            <video class="video" autoplay muted loop style>
                <source src="<?php echo e(Vite::asset('resources/views/14514414-uhd_3840_2160_25fps.mp4')); ?>" type="video/mp4">
        ...
        <div class="card">
            <video class="video" autoplay muted loop style>
                <source src="<?php echo e(Vite::asset('resources/views/4101696-hd_1920_1080_25fps.mp4')); ?>" type="video/mp4">
                Tu navegador no soporta videos.
            </video>
            <div class="card-content">
                <h3>Ubicación</h3>
        ...
        <div class="card">
            <video class="video" autoplay muted loop style>
                <source src="<?php echo e(Vite::asset('resources/views/7565182-uhd_4096_2160_25fps.mp4')); ?>" type="video/mp4">
                Tu navegador no soporta videos.
            </video>
            <div class="card-content">
                <h3>Horario</h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SERGIO\Documents\GitHub\larav0207\larav0207\resources\views/contactanos.blade.php ENDPATH**/ ?>