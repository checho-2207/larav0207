...
<body>
    ...
    <section class="hero" id="inicio">
        <video autoplay muted loop>
            <source loading="lazy" src="<?php echo e(Vite::asset('resources/views/6157787-hd_1920_1080_30fps.mp4')); ?>" type="video/mp4">
        </video>
    ...
    <section class="section2" id="productos">
        <div class="products">
            <div class="card">
                <video autoplay muted loop>
                    <source src="<?php echo e(Vite::asset('resources/views/6158066-hd_1920_1080_30fps.mp4')); ?>" type="video/mp4">
                </video>
                <h3>Mantenimiento</h3>
            ...
            <div class="card">
                <video autoplay muted loop>
                    <source src="<?php echo e(Vite::asset('resources/views/9606768-uhd_3840_2160_25fps.mp4')); ?>" type="video/mp4">
                </video>
                <h3>Reparación</h3>
            ...
            <div class="card">
                <video autoplay muted loop>
                    <source src="<?php echo e(Vite::asset('resources/views/6161372-hd_1920_1080_30fps.mp4')); ?>" type="video/mp4">
                </video>
                <h3>Repuestos</h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SERGIO\Documents\GitHub\larav0207\larav0207\resources\views/home.blade.php ENDPATH**/ ?>